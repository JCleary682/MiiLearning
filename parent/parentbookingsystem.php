    ...
    <body>
        ...
        <header id="main-header" class="py-2 bg-primary text-white">
            <div class="container">
              <div class="row">
                <div class="col-md-6">
                  <h1><i class="fa fa-gear"></i> Parent Booking</h1>
                </div>
              </div>
            </div>
        </header>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="card mx-3 bg-light">
                            ...
                            <div class="card-body">
                                <!--Booking System -->
                                <form enctype="multipart/form-data" action='parentbookingsystem.php?tutor_id=<?php echo"$tutoritem";?>' method="post" id="booking-form" name="booking" >
                                    <fieldset>
