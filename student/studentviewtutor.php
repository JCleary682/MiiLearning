...
<html lang="en">
  ...
  <body>
    <div class="container">
      ...
      <section>
        <div class='container'>
            <form class="form-inline" method="post" name="filter" action='studentviewtutor.php'>
                <div class="row">
                    <h3>Filter By:</h3>
                    <div class="col-md-3">
                                        ...
                                        <div class='col-md-3'>
                                            <div class='card mx-3 h-100'>
                                                ...
                                                <div class='card-footer'>
                                                    <a class='btn btn-primary' href='studenttutordetails.php?tutor_id=$tutoriddata'>Find Out More</a>
                                                </div>
                                            </div>
                                        </div>
                                    ";            
