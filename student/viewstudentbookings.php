...
//Querys
$id = $userarray[0];
$bookingsquery = "SELECT miiLearning_bookings.tutor_id, miiLearning_bookings.student_id, miiLearning_bookings.date, miiLearning_bookings.time, miiLearning_bookings.subject, miiLearning_bookings.price, miiLearning_level.level, miiLearning_subjects.subject, miiLearning_Users.name
FROM miiLearning_bookings
INNER JOIN miiLearning_level ON miiLearning_bookings.level = miiLearning_level.level_id
INNER JOIN miiLearning_subjects ON miiLearning_bookings.subject = miiLearning_subjects.subject_id
INNER JOIN miiLearning_Users ON miiLearning_bookings.student_id = miiLearning_Users.id
WHERE miiLearning_bookings.student_id = '$userarray[0]'
AND miiLearning_bookings.date >=  '$current_date'";
...
$previousbookingsquery = "SELECT miiLearning_bookings.tutor_id, miiLearning_bookings.student_id, miiLearning_bookings.date, miiLearning_bookings.time, miiLearning_bookings.subject, miiLearning_bookings.price, miiLearning_level.level, miiLearning_subjects.subject, miiLearning_Users.name   
                  ...
                  WHERE student_id = '$userarray[0]' AND date < '$current_date'";
    ...
    <body>
        ...
        <header id="main-header" class="py-2 bg-primary text-white">
            <div class="container">
              <div class="row">
                <div class="col-md-6">
                  <h1><i class="fa fa-gear"></i> Students Bookings <?php echo"$userarray[0]" ?></h1>
                </div>
              </div>
            </div>
        </header>
